                ...
                <a href="/" class="group" title="Ga naar home">
                    <svg class="h-8 w-auto" viewBox="0 0 287.6 51.7" role="img" aria-label="RoboGas">
                        <g>
                            ...
                            <path class="fill-white" d="M243.3,30.1l-3.7-11.1-3.7,11.1h7.4ZM245.7,37.4h-12.2l-1.9,5.6h-10.1l12.6-34.5h11l12.5,34.5h-10.1l-1.9-5.6h0Z"/>
                            <path class="fill-white"
                        ...
                        <g>
                            <path class="fill-white group-hover:fill-blue-light duration-300 transition-all" d="M14.3,0L4.1,10.2c-5.5,5.5-5.5,14.4,0,20l10.2-10.2c5.5-5.5,5.5-14.4,0-20"/>
                            <path class="fill-white group-hover:fill-blue-light duration-300 transition-all" d="M9.5,51.7l15.2-15.2c5.5-5.5,5.5-14.4,0-20l-15.2,15.2c-5.5,5.5-5.5,14.4,0,20"/>
                        </g>
                    </svg>
                </a>
