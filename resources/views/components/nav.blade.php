<nav class="fixed top-0 w-full z-50 transition-transform navbar" id="nav">
    <div class="mx-auto max-w-7xl relative">
        <div class="flex h-24 xl:h-34 justify-between relative">
            <div class="flex shrink-0 items-center">
                <a href="/" class="group" title="Ga naar home">
                    <svg id="nav-logo" class="h-8 xl:h-10 w-auto origin-left transition-all duration-150" viewBox="0 0 287.6 51.7">
                        <g>
                            <path class="fill-white nav-blue"
                            ...
                            <path class="fill-white nav-blue" d="M243.3,30.1l-3.7-11.1-3.7,11.1h7.4ZM245.7,37.4h-12.2l-1.9,5.6h-10.1l12.6-34.5h11l12.5,34.5h-10.1l-1.9-5.6h0Z"/>
                            <path class="fill-white nav-blue"
            ...
            <div class="hidden xl:flex items-center mainnav gap-8">
                <div class="group h-full">
                    <a href="#" class="inline-flex items-center text-white h-full services-dropdown-trigger font-heading font-extrabold">
                        <span class="group-hover:text-black font-heading">Gastanks</span>
                    </a>
                    <div class="education-dropdown invisible opacity-0 group-hover:opacity-100 group-hover:visible transition-all fixed left-1/2 -translate-x-1/2 w-[100vw] bg-grey z-40 shadow-xl">
                        ...
                        <div class="mx-auto max-w-7xl py-16 grid grid-cols-2 gap-32 relative z-20">
                            <div>
                                <h5 class="text-black text-2xl lg:text-3xl 2xl:text-4xl font-black italic wrap-break-word sm:wrap-normal hyphens-auto sm:hyphens-none mb-8">
                                    Expertises
                                </h5>
                                <div class="flex flex-wrap gap-4">
                                    <a href="#" class="btn btn-primary btn-lg">123</a>
                                </div>
                            </div>
                            <div>
                                <h5 class="text-black text-2xl lg:text-3xl 2xl:text-4xl font-black italic wrap-break-word sm:wrap-normal hyphens-auto sm:hyphens-none mb-8">
                                ...
                                <div class="flex flex-wrap gap-4">
                                    <a href="#" class="btn btn-secondary btn-lg">345</a>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <a href="#" class="inline-flex items-center text-white hover:text-black group font-heading font-extrabold">
                    Gasflessen
                </a>
                <a href="#" class="inline-flex items-center text-white hover:text-black group font-heading font-extrabold">
                    Onze kennis
                ...
                <a href="#" class="inline-flex items-center text-white hover:text-black group font-heading font-extrabold">
                    Vacatures
                    <span class="bg-yellow rounded-full w-6 h-6 flex justify-center items-center ml-2 group-hover:rotate-360 transition-all duration-500">
            ...
            <div class="-mr-2 flex items-center xl:hidden">
                <button id="mobile-menu-toggle"
                        type="button"
                        class="relative inline-flex items-center justify-center bg-pearl rounded-full p-2 text-white hover:bg-green-light hover:text-white focus:ring-0 focus:outline-hidden"
    ...
    <div id="mobile-menu" class="opacity-0 max-h-0 overflow-hidden transition-all duration-300 ease-in-out bg-white">
        <div class="max-w-7xl mx-auto">
            <div class="space-y-3 pt-8 pb-12 flex flex-col gap-2">
                <div class="flex flex-col gap-4">
                    <a href="#" class="inline-flex items-center text-black hover:text-yellow group">
                        23
                    </a>
                    <div class="pl-4 flex flex-col gap-3">
                        <span class="text-sm font-semibold uppercase tracking-wide text-grey-dark">Expertises</span>
                        <div class="flex flex-wrap gap-3">
                            <a href="#" class="btn btn-primary">ttrr</a>
                        </div>
                    </div>
                    <div class="pl-4 flex flex-col gap-3">
                        <span class="text-sm font-semibold uppercase tracking-wide text-grey-dark">Diensten</span>
                        <div class="flex flex-wrap gap-3">
                            <a href="#" class="btn btn-secondary">fiets</a>
                        </div>
                    </div>
                </div>
                <a href="#" class="inline-flex items-center text-black hover:text-yellow group">
...
<div class="max-w-7xl mx-auto relative">
    <div class="fixed right-0 top-auto bottom-0 md:bottom-auto md:top-24 xl:top-34 z-50 flex items-center overflow-hidden text-white shadow-lg">
        <a href="#" class="absolute inset-0 z-20 cursor-pointer" aria-label="Bel ons"></a>
        <span class="flex h-14 w-14 shrink-0 items-center justify-center bg-yellow">
